...
Copy aws-apigateway-getlyrics-1.0.0.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
// create a client
final GetLyricsClient client = factory.build(GetLyricsClient.class);
